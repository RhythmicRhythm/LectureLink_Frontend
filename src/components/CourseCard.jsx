...
import { RiBookOpenLine, RiUserLine, RiMoreFill, RiBookmarkLine, RiBookmarkFill } from 'react-icons/ri';
    ...
    <div className="bg-white rounded-lg shadow-sm overflow-hidden hover:shadow-md transition-shadow duration-300">
      ...
      <div className="p-5">
        ...
        <div className="mt-4 flex space-x-2">
          <button className="bg-indigo-600 hover:bg-indigo-700 text-white py-2 px-4 rounded-md text-sm flex-1">
            Go to Course
          </button>
